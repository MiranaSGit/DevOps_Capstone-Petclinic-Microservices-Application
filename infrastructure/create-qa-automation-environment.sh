...
APP_NAME="Petclinic"
CFN_KEYPAIR="Call-$APP_NAME-dev-${BUILD_NUMBER}.key" # edit pem file name
...
export APP_STACK_NAME="Call-$APP_NAME-App-${BUILD_NUMBER}"# edit based on the stack which runs currently by using CloudFormation Page in the Amazon Console - like "Mirana-$APP_NAME-App-4"
